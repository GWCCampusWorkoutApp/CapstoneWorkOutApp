...
class SnacksViewController: UIViewController {
    ...
    @IBAction func snacksButton(_ sender: Any) {
        func recommendRandomly() {
            ...
            chunkyMonkeyLabel.text = myRecommendation
        }
    }
